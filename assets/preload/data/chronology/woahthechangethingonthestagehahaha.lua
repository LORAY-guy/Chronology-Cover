local stuff = {
    {songTitle = 'chronology', opponentColor = '3fe780', playerColor = 'a357ab', gfColor = 'd4363c'}
}
...
function onStepHit()
    ...
    if curStep == 704 or curStep == 720 then
        cameraFlash('camGame', 'FFFFFF', (crochet / 1000) * 4)
        setProperty('defaultCamZoom', getProperty('defaultCamZoom') + 0.1)
    end

    if curStep == 736 or curStep == 744 or curStep == 752 then
        cameraFlash('camGame', 'FFFFFF', (stepCrochet / 1000) * 8)
